...
module.exports.help = (async () => {
    return {
        ...
        aliases: ["-m", "-member", "remmem", "rem-mem"],
        description: "Removes a player from any team.",
        permission: (await GROUP).MOD,
        usage: "removemember [MC IGN]"// <player name> <type permanent|temporary> [start_date] [end_date] <reason>"
    }
})()
